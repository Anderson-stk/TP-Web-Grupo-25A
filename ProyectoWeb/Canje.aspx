<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Canje.aspx.cs" Inherits="ProyectoWeb.Canje" %>
    ...
    <div class="col-12 col-md-8 col-lg-6">
        <div class="mb-4">
            ...
            <div class="input-group">
                ...
                <asp:TextBox CssClass="form-control form-control-lg" ID="exampleFormControlInput1" 
                    placeholder="Ej: XyZ456" runat="server" style="border-color: #077a45;"/>
            </div>
        </div>
        ...
        <div class="d-grid">
            <asp:Button Text="Siguiente" CssClass="btn btn-lg py-2 fw-semibold" 
                ...
                style="background-color: #077a45; border-color:#077a45; color: white;"/>
        </div>
    </div>
</div>
</asp:Content>
